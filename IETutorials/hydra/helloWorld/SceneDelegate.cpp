...
/*virtual*/
pxr::VtValue SceneDelegate::GetCameraParamValue(pxr::SdfPath const &cameraId, pxr::TfToken const &paramName)
{
    auto vcache = pxr::TfMapLookupPtr(_valueCacheMap, cameraId);
    pxr::VtValue ret;
