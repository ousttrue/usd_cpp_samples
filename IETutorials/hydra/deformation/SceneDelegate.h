...
private:
	...
	float rotation;
	static constexpr int numXSegments = 256;
	static constexpr int numYSegments = 256;

	static constexpr int numXVerts = numXSegments + 1;
	static constexpr int numYVerts = numYSegments + 1;
